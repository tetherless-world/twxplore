  ...
  implicit val manualTree = new FromInput[Tree] {
    ...
    def fromResult(node: marshaller.Node) = {
      ...
      Tree(
        ...
        species = ad.get("species").asInstanceOf[Option[TreeSpecies]],
        ...
        postcode = ad.get("postcode").asInstanceOf[Postcode],
        city = ad.get("city").asInstanceOf[City],
        zipCity = ad.get("zipCity").asInstanceOf[ZipCity],
        community = ad.get("community").asInstanceOf[Int],
        borough = ad.get("borough").asInstanceOf[Borough],
        ...
        NTA = ad.get("NTA").asInstanceOf[Nta],
        boroughCount = ad.get("boroughCount").asInstanceOf[Int],
        state = ad.get("state").asInstanceOf[State],
        ...
        censusTract = ad.get("censusTract").asInstanceOf[Option[CensusTract]],
