...
@Singleton
class TreeGraphQlController @Inject()(featureStore: FeatureStore, hierarchyStore: HierarchyStore, system: ActorSystem, treeStore: TreeStore) extends AbstractGraphQlController[TreeGraphQlSchemaContext](TreeGraphQlSchemaDefinition.schema, system) {
