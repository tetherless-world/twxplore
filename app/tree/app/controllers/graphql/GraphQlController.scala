...
@Singleton
class GraphQlController @Inject()(store: LegacyStore, system: ActorSystem) extends AbstractGraphQlController[GraphQlSchemaContext](GraphQlSchemaDefinition.schema, system) {
