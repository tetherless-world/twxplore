...
object GeoTestData {
  ...
  val containedFeature = Feature(geometry = containedGeometry, label = Some("Contained feature"), uri = Uri.parse("http://example.com/containedFeature"))
  ...
  val containingFeature = Feature(geometry = containingGeometry, label = Some("Containing feature"), uri = Uri.parse("http://example.com/containingFeature"))
  ...
  val feature = Feature(geometry = featureGeometry, label = Some("Test feature"), uri = Uri.parse("http://example.com/feature"))
}
