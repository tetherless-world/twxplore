...
object GeoTestData {
  ...
  val containedFeature = GenericFeature(geometry = containedGeometry, label = Some("Contained feature"), uri = Uri.parse("http://example.com/containedFeature"))
  ...
  val containingFeature = GenericFeature(geometry = containingGeometry, label = Some("Containing feature"), uri = Uri.parse("http://example.com/containingFeature"))
  ...
  val feature = GenericFeature(geometry = featureGeometry, label = Some("Test feature"), uri = Uri.parse("http://example.com/feature"))
}
