package io.github.tetherlessworld.twxplore.lib.base.controllers.graphql
...
abstract class AbstractGraphQlSchemaDefinition[ContextT](schema: Schema[ContextT, Unit], system: ActorSystem) extends InjectedController {
